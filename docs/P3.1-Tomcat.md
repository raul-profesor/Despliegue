...
Para este cometido podéis seguir [el siguiente tutorial](https://techviewleo.com/install-apache-tomcat-on-debian-bookworm/) hasta el paso 7 inclusive (sin configurar nada de proxy inverso), hasta el paso 7 inclusive pero únicamente el "Method 1".
